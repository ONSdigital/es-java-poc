package algorithmia.myjavaalgorithm;
...
/**
 * Unit test for myjavaalgorithm algorithm
 */
public class myjavaalgorithmTest extends TestCase {
    /**
     * Create the test case
     *
     * @param testName name of the test case
     */
    public myjavaalgorithmTest(String testName) {
        super(testName);
    }
    ...
    public static Test suite() {
        return new TestSuite(myjavaalgorithmTest.class);
    }

    /**
     * Basic test
     */
    public void testmyjavaalgorithm() throws Exception {
        ...
        myjavaalgorithm algorithm = new myjavaalgorithm();
